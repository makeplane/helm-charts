...
| env.opensearch_remote_username           |                                   |          | Username for remote OpenSearch service. Required when `services.opensearch.local_setup=false` and `env.opensearch_remote_url` is set.                                                                                                                                                                                                      |
| env.opensearch_remote_password           |                                   |          | Password for remote OpenSearch service. Required when `services.opensearch.local_setup=false` and `env.opensearch_remote_url` is set.                                                                                                                                                                                                      |
...
| opensearch_existingSecret | `OPENSEARCH_PASSWORD`  | Required if `opensearch.local_setup=true`                       | Password for local OpenSearch                | `Secure@Pass#123!%^&*`                                                                                                                                                                               |
...
|                          | `OPENSEARCH_URL`       | Required if `opensearch.local_setup=false`                      | Remote OpenSearch connection URL             | **external service example**: `https://your-opensearch-host:9200`                                                                                                                                   |
|                          | `OPENSEARCH_USERNAME`  | Required if `opensearch.local_setup=false`                      | Username for remote OpenSearch service       | `your_remote_username`                                                                                                                                                                               |
|                          | `OPENSEARCH_PASSWORD`  | Required if `opensearch.local_setup=false`                      | Password for remote OpenSearch service       | `your_remote_password`                                                                                                                                                                                |
