...
| opensearch_existingSecret | `OPENSEARCH_PASSWORD`  | Required if `opensearch.local_setup=true`                       | Password for OpenSearch                      | `Secure@Pass#123!%^&*`                                                                                                                                                                               |
|                          | `OPENSEARCH_INITIAL_ADMIN_PASSWORD` | Required if `opensearch.local_setup=true` | Initial admin password for OpenSearch       | `Secure@Pass#123!%^&*`                                                                                                                                                                               |
...
|                          | `OPENSEARCH_PASSWORD`  | Required if `opensearch.local_setup=true`                       | Password for OpenSearch                      | `Secure@Pass#123!%^&*`                                                                                                                                                                               |
...
|                          | `OPENSEARCH_USERNAME`  | Required if OpenSearch is enabled                               | Username for OpenSearch                      | `plane`                                                                                                                                                                                               |
