...
| services.mcp_server.tag             |                    v0.3.2                    |          | Image tag for the MCP server. Unlike the other services this is not tied to `planeVersion`, because the MCP server is released on its own cadence.                                              |
